...
$id = '';
$id = $_GET['id'];
$SUBJECT_SUB_CATEGORY = new SubjectSubCategory($id);
?>
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Subject Sub Category</title>
                                ...
                                <div class="col-md-12"> 
                                    ...
                                    <div class="card">
                                        <div class="card-header"> 
                                            <strong>Edit Subject Sub Category</strong>
                                        </div>
                                    </div>
                                    <form class="demo-form-wrapper card "  method="post" style="padding: 50px"   id="form-data">
                                        <div class="form form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-11">
                                                    <input id="name" name="name" class="form-control" type="text" value="<?php echo $SUBJECT_SUB_CATEGORY->name ?>"  >
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3"></div> 
                                                <div class="col-md-3"> 
                                                    <input type="hidden" name="id" value="<?php echo $SUBJECT_SUB_CATEGORY->id ?>">
