...
if ($details) {
    ...
    if ($STUDENT->GenarateCode($email)) {
        ...
        $html .= "<tr><th colspan='3' style='font-size: 18px; padding: 30px 25px 0 25px; color: #fff; text-align: center; background-color: #4184F3;'><h2>ECollage.lk</h2> </th> </tr>";
        ...
        $html .= "<tr><td colspan='3' style='font-size: 14px; padding: 0 25px 10px 25px; color: #666; background-color: #fff; '><b>Student Name: </b> " . $username . "</td></tr>";
