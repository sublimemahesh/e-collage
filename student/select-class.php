                                    ...
                                    <div class="card ">
                                        <div class="card-image">
                                            <a class="card-link" href="#">
                                                <img class="card-img-top img-responsive" src="../lecture/upload/lecture/profile/<?php echo $LECTURE->image_name ?>" alt="Capriasca, Switzerland" style="width: 100%">
                                            </a>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <center>
                                                <input type="submit" class="btn btn-primary btn-block"   value="Select" id="create" style="width: 40%">
