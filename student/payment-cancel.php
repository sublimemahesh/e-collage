    ...
    <body>
        <div class="error">
            <div class="error-body">
                <h1 class="error-heading  " style="color:red">Your Payment is Canceled..!</h1>
                <h4 class="error-subheading">Your class payment is Canceled. Please tray again..!</h4>

                <p><a class="btn btn-primary btn-pill btn-thick" href="index.php">Return to Home Page</a></p>
            </div>
